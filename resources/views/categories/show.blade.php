                    ...
                    <div class="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-sm">
                        <form action="{{ url()->current() }}" method="GET" id="filter-form">
                            <h3 class="text-sm font-black uppercase tracking-widest text-gray-900 mb-6 flex items-center gap-2">
                                <svg class="h-4 w-4 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" /></svg>
                                {{ __('Filtres') }}
                            </h3>
                            ...
                            <div class="mb-8">
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <div class="space-y-1">
                                        <input type="number" name="min_price" value="{{ request('min_price') }}" placeholder="Min" 
                                            class="w-full rounded-xl border-gray-100 bg-gray-50 text-sm font-bold focus:border-red-500 focus:ring-red-500">
                                    </div>
                                    <div class="space-y-1">
                                ...
                                <button type="submit" class="mt-4 w-full rounded-xl bg-gray-900 py-3 text-[10px] font-black uppercase tracking-widest text-white transition-all hover:bg-red-600">
                                    {{ __('Appliquer') }}
                                </button>
                            </div>

                            @if(request()->anyFilled(['brand', 'min_price', 'max_price']))
                                <a href="{{ url()->current() }}" class="text-[10px] font-bold text-red-600 uppercase tracking-widest hover:underline">
                ...
                <div class="flex-1">
                    <div class="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <select name="sort" class="rounded-xl border-gray-100 bg-white text-sm font-bold focus:border-red-500 focus:ring-red-500"
                    ...
                    @if ($products->isEmpty())
                        <div class="bg-white rounded-[2.5rem] p-12 text-center border border-gray-100 shadow-sm">
                            ...
                            <a href="{{ url()->current() }}" class="mt-8 inline-flex items-center justify-center rounded-full bg-red-600 px-8 py-4 text-[10px] font-black uppercase tracking-widest text-white shadow-lg shadow-red-900/20 transition-all hover:bg-red-700">
                                {{ __('Voir tout') }}
                            </a>
                        </div>
                    @else
