            ...
            <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100 space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-6 mt-2">
                        ...
                        <label class="cursor-pointer inline-flex items-center px-4 py-2 bg-gray-900 text-white text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-blue-600 transition-colors">
                            Changer le logo
                ...
                <div>
                    ...
                    <textarea name="adresse_siege" rows="3"
                        class="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-blue-600 font-medium transition-all">{{ old('adresse_siege', $settings->adresse_siege ?? '') }}</textarea>
                </div>
            </div>
                ...
                <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100 space-y-6">
                    ...
                    <div>
                        <textarea name="opening_hours" rows="4" placeholder="Ex: Lun-Ven: 9h-18h"
                            class="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-blue-600 font-medium transition-all">{{ old('opening_hours', $settings->opening_hours ?? '') }}</textarea>
                    </div>
                </div>
                ...
                <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="bank_address" rows="2"
                            class="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-blue-600 font-medium transition-all">{{ old('bank_address', $settings->bank_address ?? '') }}</textarea>
                    </div>
                    ...
                    <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-2xl">
                        <input type="checkbox" name="show_rib_on_order" id="show_rib_on_order" value="1" {{ old('show_rib_on_order', $settings->show_rib_on_order) ? 'checked' : '' }}
                            class="w-6 h-6 text-blue-600 border-none rounded-lg focus:ring-blue-600 focus:ring-offset-0">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="payment_instructions_de" rows="4" placeholder="Instructions en allemand..."
                                class="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-blue-600 font-medium transition-all">{{ old('payment_instructions_de', $settings->payment_instructions_de ?? '') }}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea name="payment_instructions_fr" rows="4" placeholder="Instructions en français..."
                                class="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-blue-600 font-medium transition-all">{{ old('payment_instructions_fr', $settings->payment_instructions_fr ?? '') }}</textarea>
                        </div>
                    </div>
                </div>
