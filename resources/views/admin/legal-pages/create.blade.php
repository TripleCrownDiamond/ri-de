            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="content" rows="15" required
                        class="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-red-600 font-medium transition-all">{{ old('content', $legalPage->content ?? '') }}</textarea>
                    ...
                    <div class="mt-4 p-6 bg-gray-50 rounded-2xl border border-dashed border-gray-200">
                        <h4 class="text-[10px] font-black uppercase tracking-widest text-gray-500 mb-4 flex items-center">
                            <svg class="w-4 h-4 mr-2 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                            ...
                            @foreach($codes as $code => $label)
                                <div class="flex flex-col p-2 bg-white rounded-xl border border-gray-100 shadow-sm">
                                    <code class="text-[10px] font-black text-red-600 mb-1">{{ $code }}</code>
