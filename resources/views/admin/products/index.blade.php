...
<div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden">
    <div class="p-8 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
        ...
        <a href="{{ route('admin.products.create', ['locale' => app()->getLocale()]) }}" class="px-6 py-3 bg-red-600 text-white text-sm font-bold rounded-2xl shadow-lg shadow-red-900/20 hover:scale-105 transition-all">
            + Ajouter un produit
        </a>
    </div>
