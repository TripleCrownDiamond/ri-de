...
<div class="max-w-5xl mx-auto" x-data="cloudinaryUpload()">
    <form action="{{ isset($product) ? route('admin.products.update', ['locale' => app()->getLocale(), 'product' => $product]) : route('admin.products.store', ['locale' => app()->getLocale()]) }}" method="POST">
        @csrf
