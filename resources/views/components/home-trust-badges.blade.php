<section class="relative z-10 -mt-12 px-6 lg:px-8">
    <div class="mx-auto max-w-7xl">
        <div class="grid grid-cols-1 overflow-hidden rounded-[2.5rem] border border-gray-100 bg-white shadow-2xl shadow-gray-200/50 sm:grid-cols-2 lg:grid-cols-4">
            {{-- Badge 1 --}}
            <div class="group relative flex items-center gap-6 border-b border-gray-50 p-8 transition-colors hover:bg-red-50/30 sm:border-r lg:border-b-0">
                <div class="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-red-50 text-red-600 transition-transform duration-500 group-hover:scale-110 group-hover:bg-red-600 group-hover:text-white">
            ...
            {{-- Badge 2 --}}
            <div class="group relative flex items-center gap-6 border-b border-gray-50 p-8 transition-colors hover:bg-red-50/30 lg:border-b-0 lg:border-r">
                <div class="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-red-50 text-red-600 transition-transform duration-500 group-hover:scale-110 group-hover:bg-red-600 group-hover:text-white">
                    <svg class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            {{-- Badge 4 --}}
            <div class="group relative flex items-center gap-6 p-8 transition-colors hover:bg-red-50/30">
                <div class="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-red-50 text-red-600 transition-transform duration-500 group-hover:scale-110 group-hover:bg-red-600 group-hover:text-white">
                    <svg class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
