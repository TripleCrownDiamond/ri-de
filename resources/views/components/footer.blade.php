                        ...
                        <div class="mt-10">
                            ...
                            <div class="mt-6 flex flex-wrap gap-4">
                                <div class="flex min-h-[3rem] w-full items-center gap-3 rounded-2xl bg-white/5 p-3 border border-white/10 transition-all hover:bg-white/10 group">
                                    <div class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-blue-600 text-white shadow-lg shadow-red-900/20 group-hover:scale-110 transition-transform">
