                    ...
                    <div>
                        ...
                        <ul role="list" class="mt-6 space-y-4">
                            <li class="flex gap-x-3">
                                <svg class="h-6 w-5 flex-none text-red-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <div class="mt-10">
                            ...
                            <div class="mt-6 flex flex-wrap gap-4">
                                <div class="flex min-h-[3rem] w-full items-center gap-3 rounded-2xl bg-white/5 p-3 border border-white/10 transition-all hover:bg-white/10 group">
                                    <div class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-red-600 text-white shadow-lg shadow-red-900/20 group-hover:scale-110 transition-transform">
                                ...
                                <div class="flex items-center gap-2 px-2 py-1 rounded-lg bg-white/5 border border-white/10">
                                    <svg class="h-4 w-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                                    </svg>
                                    <span class="text-[10px] text-gray-400 uppercase tracking-widest">{{ __('Paiement Sécurisé') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
