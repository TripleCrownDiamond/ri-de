                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="name" id="name" required value="{{ old('name', auth()->user()->name ?? '') }}"
                                    class="block w-full rounded-2xl border-gray-100 bg-gray-50 px-4 py-3 text-gray-900 shadow-sm focus:ring-2 focus:ring-red-600 focus:border-transparent transition-all @error('name') border-red-500 @enderror">
                                @error('name')
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="email" name="email" id="email" required value="{{ old('email', auth()->user()->email ?? '') }}"
                                    class="block w-full rounded-2xl border-gray-100 bg-gray-50 px-4 py-3 text-gray-900 shadow-sm focus:ring-2 focus:ring-red-600 focus:border-transparent transition-all @error('email') border-red-500 @enderror">
                                @error('email')
                                    <p class="mt-1 text-xs text-red-600 font-bold">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="tel" name="phone" id="phone" value="{{ old('phone') }}"
                                    class="block w-full rounded-2xl border-gray-100 bg-gray-50 px-4 py-3 text-gray-900 shadow-sm focus:ring-2 focus:ring-red-600 focus:border-transparent transition-all @error('phone') border-red-500 @enderror">
                                @error('phone')
                                    <p class="mt-1 text-xs text-red-600 font-bold">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea name="address" id="address" rows="3"
                                    class="block w-full rounded-2xl border-gray-100 bg-gray-50 px-4 py-3 text-gray-900 shadow-sm focus:ring-2 focus:ring-red-600 focus:border-transparent transition-all @error('address') border-red-500 @enderror">{{ old('address') }}</textarea>
                                @error('address')
                                    <p class="mt-1 text-xs text-red-600 font-bold">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea name="message" id="message" rows="4"
                                    class="block w-full rounded-2xl border-gray-100 bg-gray-50 px-4 py-3 text-gray-900 shadow-sm focus:ring-2 focus:ring-red-600 focus:border-transparent transition-all @error('message') border-red-500 @enderror">@if($product){{ __('Ich möchte folgendes bestellen:') }} {{ $product }} (SKU: {{ $sku }}) x{{ $qty ?? 1 }}@endif</textarea>
                                @error('message')
                                    <p class="mt-1 text-xs text-red-600 font-bold">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="sm:col-span-2 pt-4 border-t border-gray-100">
                                <div class="flex items-center mb-4">
                                    <input type="checkbox" name="create_account" id="create_account" value="1" x-model="createAccount"
                                        class="w-5 h-5 text-red-600 bg-gray-50 border-gray-200 rounded-lg focus:ring-red-600 focus:ring-2 transition-all cursor-pointer">
                                ...
                                <div x-show="createAccount" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 -translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-6">
                                    <div>
                                        ...
                                        <input type="password" name="password" id="password" x-bind:required="createAccount"
                                            class="block w-full rounded-2xl border-gray-100 bg-gray-50 px-4 py-3 text-gray-900 shadow-sm focus:ring-2 focus:ring-red-600 focus:border-transparent transition-all @error('password') border-red-500 @enderror">
                                        @error('password')
                                            <p class="mt-1 text-xs text-red-600 font-bold">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="sm:col-span-2 pt-4 border-t border-gray-100">
                                <div class="flex items-start">
                                    ...
                                    <label for="accept_terms" class="ml-3 text-sm font-medium text-gray-900 cursor-pointer leading-6">
                                        ...
                                        <a href="{{ route('legal.show', ['locale' => app()->getLocale(), 'legalPage' => 'agb']) }}" target="_blank" class="text-red-600 font-bold hover:underline">
